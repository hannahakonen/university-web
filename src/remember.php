...
function delete_user_token(int $user_id): bool //miksi user_id null in call auth.php 112?
//Fatal error: Uncaught TypeError: delete_user_token(): Argument #1 ($user_id) must be of type int, null given
{
